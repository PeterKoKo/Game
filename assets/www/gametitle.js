...
GameTitle.prototype = {
  ...
  addMenuOption: function(text, callback) {
    var optionStyle = { fontSize: '30px', fill: 'white', align: 'left', stroke: 'rgba(0,0,0,0)', srokeThickness: 4};
	var optionStyle2 = { fontSize: '30px', fill: 'white', align: 'right', stroke: 'rgba(0,0,0,0)', srokeThickness: 4};
    var txt = game.add.text(10, (this.optionCount * 80) + 50, text, optionStyle);
	var txt = game.add.text(10, (this.optionCount * 80) + 50, text, optionStyle2);
